...
type Character struct {
	...
	CharacterData struct {
		...
		Backdrops []struct {
			ID                         int         `json:"id"`
			Name                       string      `json:"name"`
			BackdropAvatarID           int         `json:"backdropAvatarId"`
			SmallBackdropAvatarID      int         `json:"smallBackdropAvatarId"`
			LargeBackdropAvatarID      int         `json:"largeBackdropAvatarId"`
			ThumbnailBackdropAvatarID  int         `json:"thumbnailBackdropAvatarId"`
			BackdropAvatarURL          string      `json:"backdropAvatarUrl"`
			SmallBackdropAvatarURL     string      `json:"smallBackdropAvatarUrl"`
			LargeBackdropAvatarURL     string      `json:"largeBackdropAvatarUrl"`
			ThumbnailBackdropAvatarURL string      `json:"thumbnailBackdropAvatarUrl"`
